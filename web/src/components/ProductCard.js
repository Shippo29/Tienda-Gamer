...
export default function ProductCard({ product }) {
  ...
  // Determine image source: prefer producto.imagenUrl (from backend), fall back to product.imagen (local import)
  let imageSrc = "";
  if (product && product.imagenUrl) imageSrc = `${apiBase}${product.imagenUrl}`;
  else if (product && product.imagen) imageSrc = product.imagen;
